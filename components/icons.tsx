...
export const UserGroupIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m-7.5-2.962C10.562 15.34 11.325 13.81 12.13 12.3m-3.415-3.23a9.094 9.094 0 0 0-4.042 1.026 3 3 0 0 0-.548 2.592m14.544-2.812a3 3 0 0 0-4.042-1.026M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 2a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
  </svg>
);
